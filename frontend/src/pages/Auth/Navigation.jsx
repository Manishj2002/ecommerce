  ...
  return (
    ...
    >
     ...
     <div className="relative">
      <button className="flex items-center text-gray-800 focus:outline-none" onClick={toggleDropDown}>
      ...
      {dropDownOpen && userInfo && (
        <ul   className={`absolute right-0 mt-2 mr-14 space-y-2 bg-white text-gray-600 ${
          ...
          {userInfo.isAdmin && (
            <>
            <li>
              <Link to='/admin/dashboard' className="block px-4 py-2 hover:bg-gray-100">Dasboard</Link>
            </li>
            <li>
            ...
            <li>
              <Link to='/logout' ><button  onClick={logoutHandler} className="block px-4 py-2 text-left w-full hover:bg-gray-100">Logout</button></Link>
            </li>
        </ul>
      )}
     </div>
